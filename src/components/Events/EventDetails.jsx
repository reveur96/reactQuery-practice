...
export default function EventDetails ()
{
  ...
  if (isPending)
  {
    content = <div id='event-datails-content' className='center'>
  ...
  if (isError)
  {
    content = <div id='event-datails-content' className='center'>
      <ErrorBlock title="
      Failed to lead event." message={error.info?.message || "Failed to fetch event data, please try again later."}/>
    </div>
  }
    ...
    < div id = "event-details-content" >
      ...
      <div id="event-details-info">
        <div>
          ...
          <p id="event-details-description">{data.descriptiom}</p>
      </div>
    </div>    
    </>
    )
